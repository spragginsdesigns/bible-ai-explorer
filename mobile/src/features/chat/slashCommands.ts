/**
 * Slash commands for the chat inputs. "local" commands are handled by the app
 * itself; "ai" commands are sent to the model verbatim - the backend system
 * prompt teaches it how to execute each one with its tools.
 */
export type LocalCommandAction = "new" | "clear" | "history" | "suggest" | "clear-note-chat";
