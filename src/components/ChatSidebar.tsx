	...
	return (
		<div className="flex flex-col pb-3">
			...
			{conversations.length > 0 && (
				<button
					onClick={onClearAll}
					className="mt-2 w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-neutral-500 dark:text-neutral-600 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-500/10 dark:hover:bg-red-400/10 transition-colors text-xs"
				>
					<Trash2 className="w-3.5 h-3.5" />
