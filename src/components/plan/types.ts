/**
 * The reading-plan shapes exactly as `/api/reading-plans` serves them.
 * Mirrors `mobile/src/features/plan/types.ts`; the server side of the same
 * shapes lives in `src/lib/reading-plans.ts`.
 */
