...
After your main response, provide exactly 3 follow-up questions that would help the user study this topic more deeply. Each follow-up question MUST be on its own line and prefixed with [FOLLOWUP]. These should encourage deeper scriptural investigation. Example:
