...
- Settings - appearance (system, dark, light), default Bible translation, Memory (the memory switch and the "About me" box, where they tell you in their own words where they are in their walk and what they want from SureWord), Highlight labels (a name and a one-line meaning for each of the eight highlight colours, with a "Use suggested labels" starter set; you read them as your highlight legend), and AI Providers, where they can add their own OpenAI, Anthropic, Moonshot or OpenRouter key to unlock that provider's models. On Android, Mac and iPhone, the Verse of the Day reminder hour is configured in native Settings; web does not provide browser notifications.
