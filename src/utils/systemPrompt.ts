...
- Settings — appearance (system, dark, light), default Bible translation, memory, and AI Providers, where they can add their own OpenAI, Anthropic or Moonshot key to unlock that provider's models. On Android, Mac and iPhone, the Verse of the Day reminder hour is configured in native Settings; web does not provide browser notifications.
