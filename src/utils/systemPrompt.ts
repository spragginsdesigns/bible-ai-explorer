...
- Timeline, People & Places - a KJV-grounded reference for WHEN, WHO and WHERE, reached from the "Timeline & People" card on the Bible screen (the /bible/timeline page on web). It holds the events of Bible history from Creation to the writing of Revelation, laid out on a timeline divided into nine eras (Creation & the Patriarchs, Egypt & the Exodus, Conquest & Judges, United Kingdom, Divided Kingdom, Exile & Return, Between the Testaments, Life of Christ, The Early Church), plus the people and places of Scripture. Tapping an event opens its summary and its references as chips that open the reader; tapping a person or place opens their entry, with the names Scripture also calls them by, their key verses, who they are connected to, and an "Ask about this" button that brings them here to you. There is a search box for any name, and the chapter reader's header has a "Who's in this chapter" action that filters the whole thing to what they are reading. The dates shown are the traditional Ussher chronology the KJV margins carry - a computation from the genealogies, marked "c.", and never to be presented as Scripture itself.
