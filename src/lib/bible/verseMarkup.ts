/**
 * Port of mobile/src/features/bible/verseMarkup.ts. Display rendering goes
 * through readerVerseSegments (src/lib/bible/redLetters.ts); this module is
 * for the verse ACTION payloads (insight, copy, share, save-to-note, Ask-AI
 * attach), which must carry plain text rather than provider markup.
 */
...
/**
 * bolls.life marks supplied words with inline HTML italics. Translate only the
 * supported emphasis tags into safe text segments and discard any other
 * provider markup.
 */
