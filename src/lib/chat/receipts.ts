 ...
 *
 * Pure and dependency-free so tests can import it directly. Mirrored by
 * mobile/src/lib/receipts.ts and by macos/Shared/Chat/ChatViewMessage.swift;
 * both TS copies assert against the same fixture
 * (tests/fixtures/chat-receipts.json), so a change here changes all three.
 */
